...
import { Container, H2, ListItemMark, P } from '@/shared/ui';
	...
	return (
		<div className="py-12 md:py-20">
			<Container className="grid gap-6 md:gap-12" size="sm">
				<div className="md:text-center grid gap-4 md:gap-8">
				...
				<div className="grid gap-8 md:gap-14">
					<div className="grid gap-4 md:gap-8 grid-cols-1 md:grid-cols-2">
						<div className="grid gap-3 md:gap-6 content-start">
							<H3>{`Your funds' security`}</H3>
							<ul className="grid gap-1 md:gap-2">
								<li className="relative pl-4 md:pl-[22]">
									<ListItemMark className="absolute left-0 top-1/2 -translate-y-1/2" />
					...
					<div className="grid gap-4 md:gap-8 grid-cols-1 md:grid-cols-2">
						<div className="grid gap-3 md:gap-6 content-start md:order-2">
